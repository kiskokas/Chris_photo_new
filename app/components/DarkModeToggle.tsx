...
const DarkModeToggle = () => {
  ...
  return (
    <div className="fixed bottom-5 right-20 z-50 flex flex-col items-center"> {/* Adjusted positioning and flex container */}
      <button
      ...
      >
        ...
        />
        <span
          className={`absolute left-1 flex items-center justify-center w-4 h-4 text-gray-700 rounded-full shadow transition-transform duration-200 ${
